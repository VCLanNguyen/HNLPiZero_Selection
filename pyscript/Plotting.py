...
def plot_tick(ax, fontsize):
   ...
   ax.tick_params(axis = 'x', labelsize = fontsize, direction = 'in')
   ax.tick_params(axis = 'y', labelsize = fontsize, direction = 'in')
...
def plot_1dhist(
                ...
                histtype = 'stepfilled', ifstacked = False,
                weights = None,
                color = 'indigo', 
                linecolor = 'black', linestyle = 'solid', linewidth = 0.5,
